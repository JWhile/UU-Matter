...
function UUMatter()
{
    ...
    this.menu = new Builder('div')
            ...
            .append(new Builder('p')
                .className('uu-footer')
                .html('Créé par <a href="https://github.com/JWhile" target="_blank">juloo</a> - beta 1.0.1'));
...
UUMatter.prototype.damage = function(damage)
{
    ...
    this.css('boxShadow', '0 0 '+ Math.max(this.life * 6, 4) +'px #322,'+ size +' 0 0 #911,0 '+ size +' 0 #911,-'+ size +' 0 0 #911,0 -'+ size +' 0 #911,inset 0 0 '+ ((20 - this.life) * 8) +'px #700')
};
